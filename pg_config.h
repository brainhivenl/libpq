--- /dev/null	2024-04-04 23:03:31
+++ src/include/pg_config.h	2024-04-04 23:03:03
@@ -0,0 +1,825 @@
...
+#define PG_VERSION_STR "PostgreSQL 16.2 on aarch64-unknown-linux-gnu, compiled by gcc (Ubuntu 12.3.0-1ubuntu1~23.04) 12.3.0, 64-bit"
+
